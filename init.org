...
#+begin_src emacs-lisp
  (use-package
    ...
    (setq modus-themes-italic-constructs t
          ...
          modus-themes-headings '((t . (variable-pitch 1.61803))))
    :hook
...
#+begin_src emacs-lisp
  (use-package citar
    :defer t
    :init
    (setq org-cite-global-bibliography '("~/test.bib")
...
The author seems do not support this package anymore. Also, Calibre
itself offers quite rich features which cannot be all exposed to
Emacs. I also do not read pdf or other EBook formats in Emacs, so I
quit using this package.
