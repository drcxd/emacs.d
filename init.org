...
#+begin_src emacs-lisp
  ...
  (setq foma-default-variable-pitch-font "Clear Sans"
        ...
        foma-profiles '((:name "Aporetic"
                               :fixed-pitch-font "Aporetic Sans Mono"
                               :variable-ptich-font "Aporetic Sans")
                        (:name "Cascadia" :fixed-pitch-font "Cascadia Code")
                        (:name"DejaVu"
                              :fixed-pitch-font "DejaVu Sans Mono" :variable-pitch-font "DejaVu Sans")
                        (:name "IBM" :fixed-pitch-font "IBM Plex Mono" :variable-pitch-font "IBM Plex Sans")
                        (:name "Intel" :fixed-pitch-font "Intel One Mono" :variable-pitch-font "Clear Sans")
                        (:name "JetBrains" :fixed-pitch-font "JetBrains Mono")
                        (:name "Julia" :fixed-pitch-font "JuliaMono")
                        (:name "Noto"
                               :fixed-pitch-font "Noto Sans Mono"
                               :variable-pitch-font "Noto Sans")
                        (:name "Red Hat"
                               :fixed-pitch-font "Red Hat Mono"
                               :variable-pitch-font "Red Hat Text")
                        (:name "Source"
                               :fixed-pitch-font "Source Code Pro"
                               :variable-pitch-font "Source Sans3")
                        (:name "Victor" :fixed-pitch-font "Victor Mono")
                        (:name "Myna" :fixed-pitch-font "Myna")
                        (:name "Maple Mono" :fixed-pitch-font "Maple Mono CN" :chinese-font "Maple Mono CN")))
#+end_src
