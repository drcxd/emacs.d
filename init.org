...
This is an alternative to calibredb. In my opinion, this package is
better. However, this is a problem preventing this package form
working on Windows. On Linux, I prefer this package over calibredb.
...
#+begin_src emacs-lisp
  (use-package
    ...
    ((nov-mode . visual-line-mode)
     (nov-post-html-render . toggle-truncate-lines)))
#+end_src
