...
#+begin_src emacs-lisp
  ...
  (defun my/use-font (profile-name)
    ...
    (interactive
     (let ((completion-ignore-case t))
       (list (completing-read "Font profile name: " (mapcar #'car my/font-profiles)))))
    (let ((profile (assoc profile-name my/font-profiles)))
      (if profile
          (progn
            (let ((fixed-pitch-font (nth 1 profile))
                  (weight (nth 2 profile))
                  (variable-pitch-font (nth 3 profile)))
  ...
  (defvar my/font-profiles
    '(("IBM Plex" . ("IBM Plex Mono" 'regular "IBM Plex Sans"))
      ("Iosevka" . ("Iosevka" 'regular "Iosevka Aile"))
      ("Iosevka Comfy" . ("Iosevka Comfy" 'regular "Iosevka Comfy Duo"))
      ("JetBrains Mono" . ("JetBrains Mono" 'regular "IBM Plex Sans"))
      ("Victor Mono" . ("Victor Mono" 'regular "IBM Plex Sans"))))
#+end_src
