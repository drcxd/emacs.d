...
#+begin_src emacs-lisp
  ...
  (setq foma-default-variable-pitch-font "Clear Sans"
        ...
        foma-profiles '((:name "Aporetic"
                               :fixed "Aporetic Sans Mono"
                               :variable "Aporetic Sans"
                               :serif "Aporetic Serif")
                        (:name "Cascadia" :fixed "Cascadia Code")
                        (:name "DejaVu"
                               :fixed "DejaVu Sans Mono" :variable "DejaVu Sans")
                        (:name "IBM" :fixed "IBM Plex Mono" :variable "IBM Plex Sans" :serif "IBM Plex Serif")
                        (:name "Intel" :fixed "Intel One Mono" :variable "Clear Sans")
                        (:name "JetBrains" :fixed "JetBrains Mono")
                        (:name "Julia" :fixed "JuliaMono")
                        (:name "Noto"
                        ...
                        (:name "Victor" :fixed "Victor Mono")
                        (:name "Myna" :fixed "Myna")
                        (:name "Maple Mono" :fixed "Maple Mono CN" :chinese "Maple Mono CN")))
#+end_src
