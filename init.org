...
#+begin_src emacs-lisp
  (use-package foma
    ...
    (setq foma-default-height 140
          ...
          foma-default-variable "IBM Plex Serif"
          ...
          foma-profiles `((:name "Aporetic"
                          ...
                          (:name "Source"
                                 ...
                                 :variable "Source Sans3")
                          (:name "Victor" :mono "Victor Mono")
                          (:name "Myna" :mono "Myna")
                          (:name "Monaspace"
                                 :mono "Monaspace Neon Frozen"
                                 :face-specs
                                 ((,(font-spec :family "Monaspace Neon Frozen")
                                   default
                                   fixed-pitch)
                                  (,(font-spec :family "Monaspace Radon Frozen")
                                   font-lock-doc-face
                                   font-lock-comment-face
                                   font-lock-string-face)
                                  (,(font-spec :family "Monaspace Argon Frozen")
                                   font-lock-function-name-face)
                                  (,(font-spec :family "Monaspace Krypton Frozen")
                                   font-lock-type-face
                                   font-lock-constant-face
                                   font-lock-preprocessor-face)
                                  (,(font-spec :family "Monaspace Xenon Frozen")
