...
MinGW shell. However, I consider having a built in terminal in Emacs
is worthy for all the troubles. At least for now. Maybe tomorrow I
will just use another terminal program and get rid of all these
nuances at all.
