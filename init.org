...
#+begin_src emacs-lisp
  ...
  creating new org roam nodes, and saving org roam files."
    ...
    (("C-c n f" . org-roam-node-find)
     ...
     ("C-c n d c d" . org-roam-dailies-goto-date)
     ("C-c n d c o" . org-roam-dailies-goto-today)
     ("C-c n d c y" . org-roam-dailies-goto-yesterday)
     ("C-c n d c t" . org-roam-dailies-goto-tomorrow)))
#+end_src
