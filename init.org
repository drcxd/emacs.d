...
#+begin_src emacs-lisp
    (defvar my/initial-message-list
      '("No pain, no gain."
    ...
    (setq initial-scratch-message
          (concat ";; Hello, " user-full-name "\n"
                  ";; "
                  (nth (random (length my/initial-message-list))
                       my/initial-message-list)
                  "\n"))
#+end_src
...
I still can't get Gnus work, but the config I copied from this [[threa][thread]]
