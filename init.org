...
melpa is not stable. As a result, I have to use local package archive
  ...
  (use-package
    ...
    (setq standard-themes-bold-constructs t
          ...
          standard-themes-headings '((0 . (variable-pitch 1.61803))
                                     ...
                                     (t . (variable-pitch 1.0))))
    :bind
    ("C-c t g" . standard-themes-toggle)
    :hook
  ...
  (use-package
    ...
    (setq ef-themes-mixed-fonts t
          ...
          ef-themes-headings '((0 . (variable-pitch 1.61803))
                               ...
                               (t . (variable-pitch 1.0))))
    :bind
    ("C-c t g" . ef-themes-select)
    :hook
    (ef-themes-post-load-hook . my-ef-themes-custom-face))
...
The following code is copied from =~/News/nnrss.el=. The code there is
generated by adding the server in gnus in an interactive way. See
[[info:gnus#RSS][gnus#RSS]] for more details.

#+begin_src emacs-lisp
  (setq nnrss-group-alist '(("Sacha Chua - category - emacs-news" "https://sachachua.com/blog/category/emacs-news/feed/" "Emacs, sketches, and life")))
#+end_src
...
calibredb. The =defun= is required to temporarily circumvent an issue
related to the C standard library implementation on Windows. It can be
removed after the author add this definition to the package.
...
This package also requires some additional settings, for example:
