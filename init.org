...
#+begin_src emacs-lisp
  (use-package consult
    ...
    (defvar-local my/consult-ripgrep-asks-dir nil
      "If non-nil, consult-ripgrep will ask for the directory to grep in.")
    (put 'my/consult-ripgrep-asks-dir 'safe-local-variable (lambda (_) t))
    (defun consult-ripgrep-with-prefix ()
      (interactive)
      (let ((current-prefix-arg '(4)))
        (call-interactively 'consult-ripgrep)))
    (defun my/consult-ripgrep-advice (oldfun &rest args)
      (if my/consult-ripgrep-asks-dir
          (apply oldfun '(dummy)) ;; This makes consult-ripgrep asks for directories
        (apply oldfun args)))
    :config
