...
A experimental font solution based on Monaspace font family:

#+begin_src emacs-lisp
  (defun my/set-face-font (face-font-list)
    "Set font family for each face in the last.
  FACE-FONT-LIST is a list of cons cells. The CAR of a cons cell is the
  face, the CDR of a cons cell is the font name."
    (dolist (pair face-font-list)
      (set-face-attribute (car pair) nil
                          :family (cdr pair))))

  (defun my/apply-monaspace-per-face-font ()
    "Setup several faces with Monaspace fonts."
    (interactive)
    (my/set-face-font
     '(;;; A sans font as the base font
       (default . "Monaspace Neon Frozen")
       (fixed-pitch . "Monaspace Neon Frozen")
       ;;; Handwritten font for strings and comments
       (font-lock-comment-face . "Monaspace Radon Frozen")
       (font-lock-string-face . "Monaspace Radon Frozen")
       ;;; Serif font for functions
       (font-lock-function-name-face . "Monaspace Xenon Frozen")
       ;;; Gothic font for types
       (font-lock-type-face . "Monaspace Krypton Frozen")
       ;;; Sans font for keywords
       (font-lock-type-face . "Monaspace Argon Frozen"))))
#+end_src
...
#+begin_src emacs-lisp
  (use-package foma
    ...
    :defer t
    :init
    (setq foma-fonts '(("Cascadia Code" zip "https://github.com/microsoft/cascadia-code/releases/download/v2407.24/CascadiaCode-2407.24.zip")
          ...
          foma-profiles '((:name "Aporetic"
                          ...
                          (:name "DejaVu"
                                 :mono "DejaVu Sans Mono" :sans "DejaVu Sans" :serif "DejaVu Serif")
                          (:name "IBM" :mono "IBM Plex Mono" :sans "IBM Plex Sans" :serif "IBM Plex Serif")
                          (:name "Intel" :mono "Intel One Mono" :sans "Clear Sans")
                          ...
                          (:name "Myna" :mono "Myna")
                          (:name "Monaspace Argon" :mono "Monaspace Argon Frozen")
                          (:name "Monaspace Krypton" :mono "Monaspace Krypton Frozen")
                          (:name "Monaspace Neon" :mono "Monaspace Neon Frozen")
                          (:name "Monaspace Radon" :mono "Monaspace Radon Frozen")
                          (:name "Monaspace Xenon" :mono "Monaspace Xenon Frozen")
                          (:name "Input"
                                 :mono "InputMono"
                                 :sans "InputSans"
                                 :serif "InputSerif")
...
#+begin_src emacs-lisp
  ...
  (use-package vulpea-ui
    ...
    :demand t
    :init
    (setq vulpea-ui-sidebar-size 80
