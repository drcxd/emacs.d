...
#+begin_src emacs-lisp
  (defun my/set-face-font (font-face-list)
    "Set font family for multiple faces in the list.
  FONT-FACE-LIST is a list of lists. The first element of each list is the
  font name, and the rest are the faces that use this font."
    (dolist (font-faces font-face-list)
      (let ((font-name (car font-faces))
  ...
  (defun my/apply-monaspace-per-face-font ()
    ...
    (interactive)
    (my/set-face-font
     '(("Monaspace Neon Frozen" ;; Basic sans font
        default
        fixed-pitch)
       ("Monaspace Radon Frozen" ;; Handwritten font
        font-lock-doc-face
        font-lock-comment-face
        font-lock-string-face)
       ("Monaspace Argon Frozen" ;; Another sans font
        font-lock-function-name-face)
       ("Monaspace Krypton Frozen" ;; Gothic font
        font-lock-type-face
        font-lock-constant-face
        font-lock-preprocessor-face)
       ;;; Serif font
       ("Monaspace Xenon Frozen" font-lock-keyword-face))))
#+end_src
