...
- [[https://github.com/protesilaos/iosevka-comfy][Iosevka Comfy]].
- [[https://github.com/be5invis/Iosevka][Iosevka]].

*** Variable Pitch Fonts

+ [[https://fonts.google.com/specimen/Open+Sans][Open Sans]].
+ Papyrus. Theoretically, this font is only available on Windows
  platform. It is interesting, I learn about it from the game Undertale.
+ [[https://fonts.google.com/specimen/Delius][Delius]]. I came across this font when searching for Papyrus. It
  turned out that this font is nice using with Cascadia Code.
+ Iosevka Comfy also provides variable pitch fonts.
...
#+begin_src emacs-lisp
  ...
  ;; Sample code to use the above macro
  ;; (dolist (list '(("iosevka-comfy" "Iosevka Comfy" "Iosevka Comfy Duo")
  ;;                 ("iosevka" "Iosevka" "Iosevka Aile")
  ;;                 ("jetbrains-mono" "JetBrains Mono" "IBM Plex Sans")
  ;;                 ("victor-mono" "Victor Mono" "IBM Plex Sans")
  ;;                 ("ibm-plex" "IBM Plex Mono" "IBM Plex Sans")))
  ;;   (eval `(my/def-use-font-function ,(car list) ,(cadr list) ,(caddr list))))
    ...
    (defun my/modus-themes-custom-face ()
      (modus-themes-with-colors
        (custom-set-faces
         ...
         ;; Undo what the package has done to the fill-column-indicator,
         ;; the documentation about this face is not accurate
         `(fill-column-indicator ((,c :inherit shadow :foreground unspecified :background unspecified :height unspecified))))))
