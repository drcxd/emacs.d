     ...
     ((eq system-type 'gnu/linux)
      (let ((theme-config-file "~/.config/kdeglobals"))
        (when (file-exists-p theme-config-file)
          (let ((os-theme (my/find-line-matching theme-config-file "LookAndFeelPackage")))
...
I use olivetti to center text in a buffer. I used to use
visual-fill-column mode to do this, but that package become broken in
Emacs 31.1.
...
#+begin_src emacs-lisp
  (use-package olivetti
    ...
    ((elfeed-show-mode . olivetti-mode)
     (my/visual-unfill-writing-mode . (lambda ()
                                        (if my/visual-unfill-writing-mode
                                            (olivetti-mode 1)
                                          (olivetti-mode -1))))))
#+end_src
