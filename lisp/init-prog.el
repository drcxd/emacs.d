...
(global-set-key (kbd "C-c g g") 'git-gutter)
...
(global-set-key (kbd "C-c c i") 'evilnc-comment-or-uncomment-lines)
(global-set-key (kbd "C-c c c") 'evilnc-copy-and-comment-lines)
